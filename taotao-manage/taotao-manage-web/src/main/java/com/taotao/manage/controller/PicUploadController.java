...
import com.taotao.manage.service.impl.PropertieService;
...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, propertieService.REPOSTORY_PATH), "\\", "/");
...
//		response.setContentType(MediaType.TEXT_HTML_VALUE+";charset=UTF-8");
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = propertieService.REPOSTORY_PATH + File.separator + "images";
